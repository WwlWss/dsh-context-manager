...
7. **In progress** — M7A Client artifact/loader/Remote/Slot foundation is complete; M7B0 cleans the retained Client reactive/presentation contract, M7B1 adds the authoritative Client model, M7B2 adds revision-aware mutations, M7C builds the Profile Drawer, and M7D closes browser/package compatibility.
